...
namespace Repository.Interface
{
    ...
    public class UnitOfWork<TContext> : IRepositoryFactory, IUnitOfWork<TContext>, IUnitOfWork where TContext : DbContext
    {
        ...
        {
            _context = context == null ? throw new ArgumentNullException(nameof(context)) : context;
        }
        ...
        public DbContextTransaction GetDbContextTransaction() => _context.Database.CurrentTransaction;

        public DbContextTransaction checkDbContextTransaction() => _context.Database.CurrentTransaction?? _context.Database.BeginTransaction() ;
        ...
        /// <returns>An <see cref="IQueryable{T}" /> that contains elements that satisfy the condition specified by raw SQL.</returns>
         public IQueryable<TEntity> FromSql<TEntity>(string sql, params object[] parameters) where TEntity : class => _context.Set<TEntity>().SqlQuery(sql, parameters).AsQueryable();
        ...
        public int SaveChanges(bool ensureAutoHistory = false)
        {
            ...
            if (GetDbContextTransaction() != null)
            {
                GetDbContextTransaction().Commit();
            }
